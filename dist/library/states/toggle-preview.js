...
function togglePreview(ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (post && post.type === 'text' && typeof post.disable_preview === 'boolean') {
            ...
            yield ctx.api.editMessageText(ctx.chat.id, parseInt(post.preview_id), post.content, Object.assign(Object.assign({}, options), { disable_web_page_preview: disable_preview }));
